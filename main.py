...
class UserAdmin(ModelView, model=UserEntity):
    ...
    column_list = [UserEntity.telegram_id, UserEntity.first_name, UserEntity.last_name, UserEntity.birth_date]
    column_details_list = [UserEntity.telegram_id, UserEntity.first_name, UserEntity.last_name, UserEntity.birth_date]
    column_searchable_list = [UserEntity.telegram_id, UserEntity.first_name, UserEntity.last_name, UserEntity.birth_date]
    column_sortable_list = [UserEntity.telegram_id, UserEntity.first_name, UserEntity.last_name, UserEntity.birth_date]
